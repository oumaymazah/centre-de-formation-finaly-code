...
protected $casts = [
    ...
    static::saving(function ($reservation) {
        // Si training_data est vide/null et que c'est une réservation existante, ne pas sauvegarder
        if ((empty($reservation->training_data) || $reservation->training_data == '[]') && $reservation->exists) {
            $reservation->delete();
            return false;
        }
        return true;
