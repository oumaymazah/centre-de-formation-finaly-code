...
function generateRatingStarsHtml(averageRating, totalFeedbacks) {
    ...
    if (totalFeedbacks > 0) {
        ...
        // Générer les étoiles pleines
        for (let i = 0; i < fullStars; i++) {
            ratingStarsHtml += '<i class="fa fa-star text-custom-orange"></i>';
        }
        ...
        // Ajouter une demi-étoile si nécessaire (pour 0.3-0.7)
        if (hasHalfStar) {
            ratingStarsHtml += '<i class="fa fa-star-half-alt text-custom-orange"></i>';
        }
        
        // Ajouter les étoiles vides
        for (let i = 0; i < emptyStars; i++) {
            ratingStarsHtml += '<i class="far fa-star text-muted-orange"></i>';
        }
...
// ffc107 :code couleur etoiles asfer
