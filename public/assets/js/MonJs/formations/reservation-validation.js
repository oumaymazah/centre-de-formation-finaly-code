...
//             confirmButton.style.backgroundColor = '  #8E44AD';
//         });
...
// //     // Changer le texte du bouton IMMÉDIATEMENT sans délai
// //     reservButton.innerHTML = 'Réservation en cours...';
// //     reservButton.disabled = true;
    
// //     // Forcer le re-render immédiat du DOM
// //     reservButton.offsetHeight; // Force un reflow
    
// //     // Utiliser setTimeout avec délai minimal pour permettre l'affichage du spinner
// //     setTimeout(() => {
// //         checkSameDateFormations()
// //             .then(result => {
// //                 if (result.hasSameDates) {
// //                     // Restaurer temporairement le bouton pour l'alerte
// //                     reservButton.innerHTML = originalText;
// //                     reservButton.disabled = false;
                    
// //                     return showSameDateAlert(result.sameDateFormations).then(shouldProceed => {
// //                         if (shouldProceed) {
// //                             // Remettre le spinner immédiatement après confirmation
// //                             reservButton.innerHTML = 'Réservation en cours...';
// //                             reservButton.disabled = true;
// //                             reservButton.offsetHeight; // Force reflow
...
// //                     });
// //                 } else {
// //                     // Aucune formation avec la même date, procéder directement
// //                     processReservationCallback();
// //                     return Promise.resolve();
// //                 }
// //             })
...
// //                     if (shouldProceed) {
// //                         // L'utilisateur a choisi de réserver malgré les dates communes
// //                         // Ne pas restaurer le bouton ici, car on va le transformer rapidement
// //                         // Ne pas appeler le callback standard qui modifierait le texte du bouton
// //                         // Au lieu de cela, créer la réservation directement et transformer le bouton
...
// //                                     // Restaurer le texte original du bouton en cas d'erreur
// //                                     reservButton.disabled = false;
// //                                     reservButton.innerHTML = originalText;
...
// //                 });
// //             } else {
// //                 // Aucune formation avec la même date, procéder à la réservation normalement
// //                 processReservationCallback();
// //             }
// //         })
// //         .catch(error => {
// //             console.error('Erreur lors de la validation de la réservation:', error);
// //             // En cas d'erreur, restaurer l'état du bouton
// //             reservButton.disabled = false;
// //             reservButton.innerHTML = originalText;
// //         });
// // }
