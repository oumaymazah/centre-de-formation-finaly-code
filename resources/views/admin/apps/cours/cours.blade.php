                             ...
                             <tbody>
                                 @foreach ($cours as $cour)
                                     <tr>
                                         ...
                                         <td>
                                             @if ($cour->training)
                                                 <a href="{{ route('training.detail', $cour->training_id) }}" class="text-primary">
    {{ $cour->training->title }}
</a>
                                             @else
                                                 Aucune formation
...
<td>
    <div class="action-icons">
        ...
        <span class="edit-icon action-icon"
              data-edit-url="{{ route('coursedit', $cour->id) }}"
              title="Modifier le cours"
              data-bs-toggle="tooltip"></span>

        <!-- Icône Supprimer -->
        <span class="delete-icon action-icon"
              data-delete-url="{{ route('coursdestroy', $cour->id) }}"
              data-csrf="{{ csrf_token() }}"
              title="Supprimer le cours"
              data-bs-toggle="tooltip"
              data-course-title="{{ $cour->title }}"></span>
    </div>
</td>
                                         {{-- <td>
