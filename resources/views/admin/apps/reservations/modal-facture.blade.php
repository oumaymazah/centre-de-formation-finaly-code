                            ...
                            <table class="table invoice-table">
                                <thead>
                                    <tr class="table-header-row">
                                        ...
                                        @endif
                                        <th class="text-end nowrap">Prix{{ $reservation->total_discount > 0 ? ' final' : '' }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($reservation->trainings as $index => $training)
                                        <tr>
                                            ...
                                            <td>
                                                {{ property_exists($training, 'start_date') && $training->start_date ? \Carbon\Carbon::parse($training->start_date)->format('d.m.Y') : '-' }}
                                            </td>
                                            <td>
                                                {{ property_exists($training, 'end_date') && $training->end_date ? \Carbon\Carbon::parse($training->end_date)->format('d.m.Y') : '-' }}
                                            </td>
                                            @if($reservation->total_discount > 0)
