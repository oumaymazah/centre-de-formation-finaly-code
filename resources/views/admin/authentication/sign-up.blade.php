                    ...
                    <form class="theme-form login-form needs-validation" method="POST" action="{{ route('register') }}" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control @error('password') is-invalid @enderror" type="password" name="password" required placeholder="***" id="passwordField" value="{{ old('password') }}"/>
                        ...
                        <div class="right-panel">
                            <div class="login-card">
                                <form class="theme-form login-form needs-validation" method="POST" action="{{ route('register') }}" novalidate>
                                    ...
                                    <p style="text-align: center; color: #7f8c8d;">
                                        Vous avez déjà un compte ?
                                        <a class="ms-2" href="{{ route('login') }}" style="color: #2B6ED4; text-decoration: none; font-weight: 500;">Se connecter</a>
                                    </p>
                                </form>
                            </div>
                        </div>
