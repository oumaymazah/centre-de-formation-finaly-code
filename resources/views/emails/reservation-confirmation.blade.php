    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Bonjour <span class="lastname">{{ $reservation->user->lastname ?? 'Étudiant' }}</span>,</p>
                
                <div class="info-box">
                    <p>Nous confirmons avoir reçu votre paiement de <strong>{{ number_format($totalPrice, 2, ',', ' ') }} Dt</strong>  effectué le 
                    <strong>{{ \Carbon\Carbon::parse($reservation->payment_date)->format('d/m/Y à H:i') }}</strong>
                    pour la réservation n° <strong>{{ $reservation->id }}</strong>.</p>
