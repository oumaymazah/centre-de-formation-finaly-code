...
<div class="page-main-header {{ auth()->check() ? 'authenticated-header' : '' }}">
  <div class="main-header-right row m-0 {{ auth()->check() ? 'authenticated-main-header' : '' }}">
    <div class="main-header-left {{ auth()->check() ? 'authenticated-left' : '' }}">
      ...
      <div class="logo-wrapper"><img class="img-fluid {{ auth()->check() ? 'authenticated-logo' : 'nav-logo-img' }}" src="{{ asset('assets/images/logo/elsEMPO-removebg-preview.png') }}" alt="Logo"></div>
      <div class="dark-logo-wrapper"><img class="img-fluid {{ auth()->check() ? 'authenticated-logo' : 'nav-logo-img' }}" src="{{ asset('assets/images/logo/elsEMPO-removebg-preview.png') }}" alt="Dark Logo"></div>
