...
<head>
    ...
    <title>@yield('title', 'Empowerment Learning')</title>
        ...
        <div class="page-main-header">
          <div class="main-header-right row m-0">
            ...
            <div class="main-header-left">
              <div class="logo-wrapper"><a href="{{ route('index') }}"><img class="img-fluid logo-img" src="{{asset('assets/images/logo/elsEMPO-removebg-preview.png')}}" alt="Logo"></a></div>
              <div class="dark-logo-wrapper"><a href="{{ route('index') }}"><img class="img-fluid logo-img" src="{{asset('assets/images/logo/elsEMPO-removebg-preview.png')}}" alt="Dark Logo"></a></div>
