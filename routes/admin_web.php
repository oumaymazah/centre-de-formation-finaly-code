...
Route::get('/get/categories', [App\Http\Controllers\CategorieController::class, 'getCategories'])->name('get.categories');

Route::get('api/categories', [FormationController::class, 'getCategories'])->name('api.categories');


// Route::get('/accueil', function () {
//     return view('admin.apps.home.accueil'); // Chemin corrigé
// })->name('accueil');

// Route::get('/ÀPropos', function () {
//     return view('admin.apps.home.apropos'); // Chemin corrigé
// })->name('apropos');

// Route::get('/politique', function () {
//     return view('admin.apps.home.politique'); // Chemin corrigé
// })->name('politique');
...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/ÀPropos', function () {
        return view('admin.apps.home.apropos');
    })->name('apropos');

    Route::get('/politique', function () {
        return view('admin.apps.home.politique');
    })->name('politique');
});
...
//talaa3thom bsh el user mush connect yatl3oulouuu ama baad lezm ya3ml connexion zeda
...
// Route::get('hi', [FormationController::class, 'home'])->name('hi'); // Liste
Route::get('/debug-formation/{id}', [ReservationController::class, 'debugFormationReservations']);
...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::view('knowledgebase', 'admin.miscellaneous.knowledgebase')->name('knowledgebase');
		...
		//zedthomm tw lel reservation routes apiiiiiiiiiii/////////////////


////////////// newww baad ma nadhmt el js w hatyt functions f controller lel reservation
...
Route::get('/cart/formation-button-state/{formationId}', [PanierController::class, 'getFormationButtonState']);
		//zedthaa lel status de buttons
Route::get('/certificats', [CertificationController::class, 'index'])->name('certificates.index');

		Route::get('/api/reservations/check-complete', [ReservationController::class, 'checkCompleteReservationStatus'])->middleware('auth');
    ...
    // Route::get('/check-available-seats', [FormationController::class, 'checkAvailableSeats']);
	// Route::post('/check-available-seats', [FormationController::class, 'checkAvailableSeats'])->name('check.available.seats');

	// Route::post('/check-available-seats', [FormationController::class, 'checkAvailableSeats']);
	...
	Route::get('/panier/check-dates', [PanierController::class, 'checkFormationsDates'])->name('panier.check-dates');
	...
	Route::get('/panier/verify-cart-items', [PanierController::class, 'verifyCartItemsExistence']);
...
Route::post('/formations/button-states', [App\Http\Controllers\PanierController::class, 'getFormationButtonStates']);


    Route::middleware(['role:etudiant'])->group(function () {
		Route::get('/panier', [PanierController::class, 'index'])->name('panier.index');
        		Route::get('/check-user-reservation/{formationId}', [ReservationController::class, 'checkUserReservationForFormation']);



		Route::get('/get-remaining-seats/{formationId}', [PanierController::class, 'getRemainingSeats'])->name('panier.getRemainingSeats');
        // Route::get('/panier', [PanierController::class, 'index'])->name('panier.index');
        Route::post('/panier/ajouter', [PanierController::class, 'ajouter'])->name('panier.ajouter');
        // Route::get('/panier/items', [PanierController::class, 'getCartItems'])->name('panier.items');
		Route::get('/panier/data', [PanierController::class, 'getCartData']);
