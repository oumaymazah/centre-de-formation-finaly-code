                ...
                <div class="logo">
                    <table style="margin: 0 auto;">
                        <tr>
                            ...
                            <td style="vertical-align: middle;"><h2 style="margin: 0;">EMPOWERMENT LEARNING SUCCESS CENTER</h2></td>
                        </tr>
                    </table>
                </div>
            </div>
            <div class="content">
                <h1><strong>Bienvenue <?php echo e($user->lastname); ?></strong></h1>
                ...
                <div class="code-box">
                    <div class="code"><?php echo e($user->validation_code); ?></div>
                </div>
                
                <p>Veuillez saisir ce code dans le formulaire prévu à cet effet afin d'activer votre compte.</p>
                
                <center>
                    <a href="<?php echo e(url('/validation')); ?>" class="btn">Accéder à la plateforme</a>
                </center>
            </div>
            <div class="footer">
...
</html><?php /**PATH C:\Users\hibah\P_Plateforme_ELS\resources\views/emails/account_validation.blade.php ENDPATH**/ ?>