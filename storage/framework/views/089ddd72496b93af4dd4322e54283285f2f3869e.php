...
<link href="<?php echo e(mix('css/quizzes.css')); ?>" rel="stylesheet">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="quiz-form" action="<?php echo e(route('quizzes.answer', $attempt->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="question_id" value="<?php echo e($currentQuestion->id); ?>">

                        <!-- Numéro de la question courante -->
                        <div class="text-muted mb-2">
                            Question <?php echo e($currentQuestionIndex + 1); ?> sur <?php echo e(count($questions)); ?>
                        ...
                        <div class="list-group mb-4">
                            ...
                            <label class="list-group-item d-flex align-items-center">
                                <?php if($isMultipleChoice): ?>
                                    <input type="checkbox" name="answer_ids[]" value="<?php echo e($answer->id); ?>" class="mr-2"
                                    <?php echo e(in_array($answer->id, $userAnswers[$currentQuestion->id] ?? []) ? 'checked' : ''); ?>>
                                <?php else: ?>
                                    <input type="radio" name="answer_ids[]" value="<?php echo e($answer->id); ?>" class="mr-2"
                                    <?php echo e(in_array($answer->id, $userAnswers[$currentQuestion->id] ?? []) ? 'checked' : ''); ?>>
                                <?php endif; ?>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const routes = {
        tabSwitch: "<?php echo e(route('quizzes.tab-switch', $attempt->id)); ?>",
        result: "<?php echo e(route('quizzes.result', $attempt->id)); ?>"
    };
    const config = {
        maxSwitches: 2,
    ...
    const timerInterval = setInterval(() => {
        ...
        if (timeLeft <= 0) {
            ...
            window.location.href = "<?php echo e(route('quizzes.finish', $attempt->id)); ?>";
        }
    ...
    const currentIndex = <?php echo e($currentQuestionIndex); ?>;
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\apprendre laravel\Centre_Formation-main\resources\views/admin/quizzes/attempt.blade.php ENDPATH**/ ?>