                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                ...
                                                                <?php if(isset($feedback->user)): ?>
                                                                    <small class="text-muted">Par: <?php echo e($feedback->user->name ?? 'Anonyme'); ?> <?php echo e($feedback->user->lastname ?? 'Anonyme'); ?></small>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                    </td>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                ...
                                                <h4 class="mb-0 text-dark" id="total-feedbacks"><?php echo e(count($feedbacks)); ?></h4>
                                            </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\apprendre laravel\Centre_Formation-main\resources\views/admin/apps/feedback/feedbacks.blade.php ENDPATH**/ ?>