...
<div class="container-fluid">
    ...
    <div class="card quiz-header-card">
        <div class="card-body d-flex justify-content-between align-items-center">
            ...
            <?php endif; ?>
            <?php if(auth()->user()->hasRole('professeur') ): ?>
                <a href="<?php echo e(route('training.detail',$quiz->training->id)); ?>" class="back-icon">
                    <i class="fas fa-arrow-left"></i>
                </a>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\apprendre laravel\Centre_Formation-main\resources\views/admin/quizzes/show.blade.php ENDPATH**/ ?>