                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Rechercher un etudiant par son id ou numero de téléphone..." id="roleSearch">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal-footer">
                <div class="text-end mt-2">
                    <span class="badge px-3 py-2 fs-6" style="background-color: #CFE2FF; color: #161616;">
                        Prix Total: <?php echo e(number_format($totalFinal, 2)); ?> Dt
                    </span>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?><?php /**PATH C:\Users\hibah\Downloads\P_Plateforme_ELS\P_Plateforme_ELS\resources\views/admin/apps/reservations/reservations-list.blade.php ENDPATH**/ ?>