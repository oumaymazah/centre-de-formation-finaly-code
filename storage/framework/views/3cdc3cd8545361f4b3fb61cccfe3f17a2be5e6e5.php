...
<div class="row">
    <div class="col-sm-12">
        ...
        <form id="email-form" class="ajax-form" action="<?php echo e(route('profile.sendEmailVerificationCode')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\hibah\Downloads\P_Plateforme_ELS\P_Plateforme_ELS\resources\views/admin/apps/profile/editEmail.blade.php ENDPATH**/ ?>