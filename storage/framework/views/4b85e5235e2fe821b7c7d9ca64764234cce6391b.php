            ...
            <div class="container">
                ...
                <div class="politique-content">
                    ...
                    <div class="politique-item">
                        ...
                        <div class="item-description">
                            Le délai de <span class="highlight">2 jours minimum</span> constitue une exigence absolue pour sécuriser votre place dans nos programmes. Toute réservation non validée dans ce délai sera automatiquement supprimée de notre système pour permettre l'inscription d'autres candidats.
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\P_Plateforme_ELS\resources\views/admin/apps/home/politique.blade.php ENDPATH**/ ?>