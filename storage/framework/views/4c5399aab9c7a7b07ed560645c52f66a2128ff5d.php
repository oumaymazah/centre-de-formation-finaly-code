        ...
        <div class="auth-wrapper">
            ...
            <div class="right-panel">
                ...
                <div class="login-card">
                    <form class="theme-form login-form needs-validation" id="registrationForm" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <div class="small-group">
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fa fa-user" style="color: #2B6ED4;"></i></span>
                                    <input class="form-control" name="name" type="text" required placeholder="Prénom" />
                                    <div class="invalid-feedback">Veuillez entrer un prénom.</div>
                                </div>
                                <div class="input-group">
                                    <span class="input-group-text"><i class="fa fa-user" style="color: #2B6ED4;"></i></span>
                                    <input class="form-control" name="lastname" type="text" required placeholder="Nom de famille" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-envelope" style="color: #2B6ED4;"></i></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-phone" style="color: #2B6ED4;"></i></span>
                                <input class="form-control" type="text" name="phone" required placeholder="+216 12 345 678"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="fa fa-lock" style="color: #2B6ED4;"></i></span>
                                <input class="form-control" type="password" name="password" required placeholder="***" id="passwordField" />
                        ...
                        <p style="text-align: center; color: #7f8c8d;">
                            ...
                            <a class="ms-2" href="/login" style="color: #2B6ED4; text-decoration: none; font-weight: 500;">Se connecter</a>
                        </p>
                    </form>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\hibah\P_Plateforme_ELS\resources\views/admin/authentication/sign-up.blade.php ENDPATH**/ ?>