    ...
    <?php if($certifications->count() > 0): ?>
        <div class="certification-grid">
            <?php $__currentLoopData = $certifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="certification-card" data-user="<?php echo e(auth()->id()); ?>" data-training="<?php echo e($certification->training->id); ?>">
                    <div class="certification-icon">
                        <i class="fas fa-award"></i>
                    </div>

                    <div class="certification-content">
                        <h5>Formation : <?php echo e($certification->training->title ?? 'Formation'); ?></h5>
                        <div class="certification-details">
                            <span><i class="fas fa-calendar-alt me-1"></i> Obtenu le: <?php echo e(\Carbon\Carbon::parse($certification->created_at)->format('d/m/Y')); ?></span>

                        </div>
                        <div class="certification-footer">
                            <button class="btn btn-sm btn-primary download-certificate" data-user="<?php echo e(auth()->id()); ?>" data-training="<?php echo e($certification->training->id); ?>">
...
$(document).ready(function() {
    ...
    $('.certification-card').on('click', function() {
        ...
        window.location.href = `<?php echo e(route('certificates.download', ['user' => ':userId', 'training' => ':trainingId'])); ?>`
...
<?php /**PATH D:\apprendre laravel\Centre_Formation-main\resources\views/certificates/archifageCertif.blade.php ENDPATH**/ ?>