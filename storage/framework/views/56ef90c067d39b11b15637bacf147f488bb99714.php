        ...
        <div class="col-md-6">
            <div class="card" style="border: none; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.08); padding: 25px; margin-top: 20px;">
                ...
                <div class="card-body" style="padding: 25px 20px 20px;">
                    ...
                    <form method="POST" action="<?php echo e(route('validation.code')); ?>" id="validation-form">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\Downloads\P_Plateforme_ELS\P_Plateforme_ELS\resources\views/auth/verify.blade.php ENDPATH**/ ?>