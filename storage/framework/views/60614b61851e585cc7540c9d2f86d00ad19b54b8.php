        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow border-0 rounded-lg">
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <form method="POST" action="<?php echo e(route('forgot.password.send')); ?>" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> form-control-lg" placeholder="nom@exemple.com" required>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-grid gap-2 mt-4">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="btn btn-square btn-outline-info" btn-lg d-flex align-items-center justify-content-center">
...
<?php echo $__env->make('admin.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\Downloads\P_Plateforme_ELS\P_Plateforme_ELS\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>