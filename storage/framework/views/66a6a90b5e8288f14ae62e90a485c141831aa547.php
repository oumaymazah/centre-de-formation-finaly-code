            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <span>Complétez les informations pour créer une nouvelle catégorie</span>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form theme-form">
                            <form action="<?php echo e(route('categoriestore')); ?>" method="POST" class="needs-validation" novalidate>
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\Downloads\P_Plateforme_ELS\P_Plateforme_ELS\resources\views/admin/apps/categorie/categoriecreate.blade.php ENDPATH**/ ?>