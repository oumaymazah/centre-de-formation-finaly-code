...
<body style="margin: 0; padding: 20px; font-family: Arial, sans-serif; background-color: #f5f7fa;">
  <div style="max-width: 900px; margin: auto; background: white; border: 1px solid #ccc; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1); position: relative;">
    ...
    <div style="padding: 40px 20px; text-align: center;">
      ...
      <h3 style="font-size: 20px; font-weight: bold; margin: 20px 0;"><?php echo e($training->title); ?></h3>
      ...
      <div style="display: flex; justify-content: space-around; flex-wrap: wrap; margin-top: 30px;">
        <div style=" text-align: center;">
          ...
          <p style="font-size: 16px; font-weight: bold;"><?php echo e($certification->obtained_date->format('d/m/Y')); ?></p>
        </div>
        <div style=" text-align: center;">
        ...
        <div style=" text-align: center;">
          ...
          <p style="font-size: 16px; font-weight: bold;"><?php echo e($training->duration); ?> heures</p>
        </div>
      </div>
...
<table style="width: 100%; margin-top: 40px; text-align: center; border-collapse: collapse;">
  <tr>
    ...
    <td>
      ...
      <p style="font-weight: bold;">N° <?php echo e($certification->certificate_number); ?></p>
    </td>
  </tr>
</table>
...
<?php /**PATH D:\apprendre laravel\Centre_Formation-main\resources\views/certificates/certificate.blade.php ENDPATH**/ ?>