 ...
 <div class="container-fluid">
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <?php if($cour->training): ?>
                                                 <a href="<?php echo e(route('training.detail', $cour->training_id)); ?>" class="text-primary">
    <?php echo e($cour->training->title); ?>
                                         ...
                                         <!-- Remplacez la section des actions dans votre tableau par : -->
<!-- Section des actions améliorée -->
<td>
    <div class="action-icons">
        <!-- Icône Voir (optionnel) -->


        <!-- Icône Modifier -->
        <span class="edit-icon action-icon"
              data-edit-url="<?php echo e(route('coursedit', $cour->id)); ?>"
              title="Modifier le cours"
              data-bs-toggle="tooltip"></span>

        <!-- Icône Supprimer -->
        <span class="delete-icon action-icon"
              data-delete-url="<?php echo e(route('coursdestroy', $cour->id)); ?>"
              data-csrf="<?php echo e(csrf_token()); ?>"
              title="Supprimer le cours"
              data-bs-toggle="tooltip"
              data-course-title="<?php echo e($cour->title); ?>"></span>
    </div>
</td>
