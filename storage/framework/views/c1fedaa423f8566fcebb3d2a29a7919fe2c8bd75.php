        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow border-0 rounded-lg">
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <form method="POST" action="<?php echo e(route('reset.password.verify')); ?>" class=" needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
                        <div class="form-group mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="verification-code" name="code" class="form-control <?php $__errorArgs = ['code'];
...
unset($__errorArgs, $__bag); ?> form-control-lg" placeholder="Entrez le code à 6 chiffres" required>
...
<?php echo $__env->make('admin.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\Downloads\P_Plateforme_ELS\P_Plateforme_ELS\resources\views/auth/verify-code.blade.php ENDPATH**/ ?>