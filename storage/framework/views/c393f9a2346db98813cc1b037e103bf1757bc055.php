        ...
        <div class="col-lg-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0 text-white"><i class="fas fa-graduation-cap mr-2"></i>Résultats du Quiz: <?php echo e($quiz->title); ?></h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-4 mb-md-0">
                            <div class="score-card <?php echo e($attempt->passed ? 'passed' : 'failed'); ?>">
                                ...
                                <?php if($quiz->isFinalQuiz()): ?>
                                    <p class="mt-3 mb-0">
                                        ...
                                        <?php endif; ?>
                                        <br>
                                        <small class="text-muted mt-2 d-block">Score minimum requis: <?php echo e($quiz->passing_score); ?>/20</small>
                                    </p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="detail-card">
                                ...
                                <p class="mb-2">
                                    ...
                                    <strong>Temps:</strong>
                                    <?php if($attempt->started_at && $attempt->finished_at): ?>
                                        <?php echo e($attempt->started_at->diff($attempt->finished_at)->format('%i minutes %s secondes')); ?>
                                ...
                                <p class="mb-2">
                                    ...
                                    <?php if($attempt->finished_at): ?>
                                        <?php echo e($attempt->finished_at->format('d/m/Y H:i')); ?>

                                    <?php else: ?>
                                        <?php echo e(now()->format('d/m/Y H:i')); ?> (Estimée)
                                    <?php endif; ?>
                                </p>
                                <?php if($level): ?>
                                    <p class="mb-0">
                                        ...
                                        <span class="badge badge-info"><?php echo e($level); ?></span>
                                    </p>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <?php if($quiz->isFinalQuiz() && $attempt->passed): ?>
                        <div class="certificate-container">
                            ...
                            <div class="mt-3">
                                <a href="<?php echo e(route('certificates.show', ['user' => auth()->id(), 'training' => $quiz->training_id])); ?>" class="btn btn-success">
                                    <i class="fas fa-certificate"></i> Voir le certificat
                                </a>
                                <a href="<?php echo e(route('certificates.download', ['user' => auth()->id(), 'training' => $quiz->training_id])); ?>" class="btn btn-success ml-2">
                    ...
                    <div class="accordion" id="answersAccordion">
                        ...
                        <?php $__currentLoopData = $answersGroupedByQuestion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $questionId => $questionAnswers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="card mb-2">
                                <div class="card-header" id="heading<?php echo e($questionId); ?>">
                                    <h6 class="mb-0">
                                        <button class="btn btn-link <?php echo e($isQuestionCorrect ? 'text-success' : 'text-danger'); ?> collapsed"
                                                type="button" data-toggle="collapse"
                                                data-target="#collapse<?php echo e($questionId); ?>"
                                                aria-expanded="false"
                                                aria-controls="collapse<?php echo e($questionId); ?>">
                                            <i class="fas <?php echo e($isQuestionCorrect ? 'fa-check-circle' : 'fa-times-circle'); ?>"></i>
                                            <span><?php echo e($question->question_text); ?></span>
                                ...
                                <div id="collapse<?php echo e($questionId); ?>" class="collapse" aria-labelledby="heading<?php echo e($questionId); ?>"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul>
                                            <?php $__currentLoopData = $questionAnswers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="<?php echo e($answer->is_correct ? 'text-success' : 'text-danger'); ?>">
                                                    <span><?php echo e($answer->answer->answer_text); ?></span>
                                                    <i class="fas <?php echo e($answer->is_correct ? 'fa-check' : 'fa-times'); ?>"></i>
                                                </li>
                                        ...
                                        <?php if(!$isQuestionCorrect): ?>
                                            ...
                                            <ul class="text-success">
                                                <?php $__currentLoopData = $correctAnswers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $correctAnswer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if(!in_array($correctAnswer->id, $userSelectedAnswerIds)): ?>
                                                        <li><?php echo e($correctAnswer->answer_text); ?></li>
                                                    <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                                        <?php endif; ?>
                    ...
                    <div class="mt-4 d-flex justify-content-between align-items-center">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('training.detail',$quiz->training->id)); ?>" class="btn btn-primary">
                                <i class="fas fa-file-alt"></i>Retour à la page de détails
                            </a>
                        <?php endif; ?>
                        <?php if($quiz->isFinalQuiz()): ?>
...
<div class="modal fade" id="feedbackModal" tabindex="-1" role="dialog" aria-labelledby="feedbackModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo e(route('feedbacks.store')); ?>" method="POST" id="feedbackForm">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="training_id" value="<?php echo e($quiz->training_id); ?>">
                <input type="hidden" name="quiz_attempt_id" value="<?php echo e($attempt->id); ?>">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="text-center mt-3">
                            <span  id="rating-value">Pas de note</span>/5
                        </div>
...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        method: 'GET',
        data: {
            quiz_attempt_id: '<?php echo e($attempt->id); ?>'
        },
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\apprendre laravel\Centre_Formation-main\resources\views/admin/quizzes/result.blade.php ENDPATH**/ ?>