...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                <h1><strong>Activation de votre compte ELS</strong></h1>

                <p>Bonjour <strong><?php echo e($user->name); ?> <?php echo e($user->lastname); ?></strong>,</p>
                
                <p>Votre compte a été créé avec succès sur la plateforme ELS.</p>
                
                <div class="credentials-box">
                    <span class="credentials-title">Vos identifiants de connexion :</span>
                ...
                <p>Pour activer votre compte, vous devrez saisir le code de validation suivant lors de votre première connexion : <span class="code-inline"><?php echo e($code); ?></span></p>
                ...
                <center>
                    <a href="<?php echo e(url('/login')); ?>" class="btn">Se connecter</a>
                </center>
            ...
            <div class="footer">
                ...
                <p>© <?php echo e(date('Y')); ?> ELS Formation. Tous droits réservés.</p>
...
</html><?php /**PATH D:\apprendre laravel\Centre_Formation-main\resources\views/emails/user_created.blade.php ENDPATH**/ ?>