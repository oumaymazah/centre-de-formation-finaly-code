...
<div class="modal fade" id="invoiceModal<?php echo e($reservation->id); ?>" tabindex="-1" aria-labelledby="invoiceModalLabel<?php echo e($reservation->id); ?>" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body p-0" id="invoiceContent<?php echo e($reservation->id); ?>">
                            ...
                            <div class="col-7">
                                <div class="logo-container">
                                    <div class="logo-wrapper">
                                        <img src="<?php echo e(asset('img/logo.png')); ?>" alt="Logo CENTRE ELS" class="invoice-logo" onerror="this.src='https://via.placeholder.com/120x60?text=CENTRE+ELS'">
                                    </div>
                        ...
                        <div class="col-6">
                            <div class="invoice-info-box">
                                <div class="invoice-to">
                                    <h5>Facturé à:</h5>
                                    <p>
                                        <strong><?php echo e(auth()->user()->name); ?> <?php echo e(auth()->user()->lastname); ?></strong><br>
                                        <?php if(auth()->user()->address): ?>
                                            <i class="fas fa-map-marker-alt me-1"></i> <?php echo e(auth()->user()->address); ?><br>
                                        <?php endif; ?>
                                        <?php if(auth()->user()->phone): ?>
                                            <i class="fas fa-phone-alt me-1"></i> <?php echo e(auth()->user()->phone); ?><br>
                                        <?php endif; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <?php if($training->discount > 0): ?>
                                                    ...
                                                    (<?php echo e(number_format($training->discount_amount, 2, ',', ' ')); ?> Dt)
                                                <?php else: ?>
                                                    -
                                                <?php endif; ?>
                                            </td>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary print-invoice" data-invoice-id="<?php echo e($reservation->id); ?>">
                    <i class="fas fa-print"></i> Imprimer
                </button>
                <button type="button" class="btn btn-danger download-pdf" data-reservation-id="<?php echo e($reservation->id); ?>">
...
</style><?php /**PATH C:\Users\hibah\Downloads\P_Plateforme_ELS\P_Plateforme_ELS\resources\views/admin/apps/reservations/modal-facture.blade.php ENDPATH**/ ?>