    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Bonjour <span class="lastname"><?php echo e($user->lastname); ?></span>,</p>
                
                <p>Nous souhaitons vous rappeler que vous avez <span class="important"><?php echo e(count($trainings)); ?> formation(s)</span> qui débuteront dans <span class="important">2 jours</span>, le <span class="important"><?php echo e($startDate); ?></span>.</p>
                ...
                <div class="info-box">
                    ...
                    <div class="training-item">
                        <p><strong>Formation <?php echo e($index + 1); ?>: <?php echo e($training->title); ?> </strong></p>
                    </div>
...
</html><?php /**PATH C:\Users\hibah\P_Plateforme_ELS\resources\views/emails/formation-reminder.blade.php ENDPATH**/ ?>