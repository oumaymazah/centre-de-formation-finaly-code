	                                ...
	                                <div class="col-sm-6">
	                                    <div class="media">
	                                        <div class="media-left">
	                                            <a href="<?php echo e(route('index')); ?>"><img class="media-object img-60" src="<?php echo e(asset('assets/images/logo/logo-1.png')); ?>" alt="" /></a>
	                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\PFE\PlateformeELS\resources\views/admin/apps/ecommerce/invoice-template.blade.php ENDPATH**/ ?>