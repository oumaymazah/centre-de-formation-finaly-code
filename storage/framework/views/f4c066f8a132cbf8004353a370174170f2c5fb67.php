        ...
        <div class="col-md-8 col-lg-6">
            <div class="card border-0 shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="card-body p-4 bg-white">
                    ...
                    <form method="POST" action="<?php echo e(route('password.reset.update')); ?>" class="needs-validation" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> border-start-0 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="password" required placeholder="Entrez votre nouveau mot de passe">
...
unset($__errorArgs, $__bag); ?> border-start-0" name="password_confirmation" required placeholder="Confirmez votre nouveau mot de passe">
                        ...
                        <div class="text-center mt-4">
                            <a href="<?php echo e(route('login')); ?>" class="text-decoration-none" style="color:  #2B6ED4;">
...
<?php echo $__env->make('admin.authentication.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hibah\Downloads\P_Plateforme_ELS\P_Plateforme_ELS\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>